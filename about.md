<div class="about-header">
  <img src="assets/profile.jpg" alt="Portrait of Tim Herzig" class="about-avatar" width="160" height="160" loading="lazy" />
  ...
  <a href="https://scholar.google.com/citations?user=TkxGNr0AAAAJ&hl=en&oi=ao" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="https://github.com/timherzig" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="https://www.linkedin.com/in/tim-herzig-6371251a6/" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="mailto:tim.herzig@hotmail.com" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
...
I'm a **Computer Science Master's graduate** from **Technische Universität Berlin**, and have been working in **Audio ML Research** at **Deutsches Forschungsinstitut für Künstliche Intelligenz** (DFKI) for 4 years. I recently completed an Internship as an **AI Engineer** at the startup Algonaut GmbH.
