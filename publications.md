...
<div class="publication-card">
    ...
    <div class="publication-content">
        ...
        <div class="publication-venue">INTTERSPEECH 2024</div>
...
<div class="publication-card">
    <div class="publication-image">
        <img src="assets/publications/2023_decomposer.png" alt="Decomposer publication">
    </div>
    <div class="publication-content">
        <h3 class="publication-title">
        ...
        <div class="publication-authors">Boris Meinardus, Mariusz Trzeciakiewicz, Tim Herzig, Monika Kwiatkowski, Simon Matern, Olaf Hellwich</div>
...
<div class="publication-card">
    <div class="publication-image">
        <img src="assets/publications/2022_wav2vec_dysartric_ASR.png" alt="Dysarthric Speech publication">
    </div>
    <div class="publication-content">
        <h3 class="publication-title">
        ...
        <div class="publication-venue">INTERSPEECH 2022</div>
        <div class="publication-authors">Murali Karthick Baskar, Tim Herzig, Diana Nguyen, Mireia Diez, Tim Polzehl, Lukáš Burget, Jan "Honza'' Černocký</div>
